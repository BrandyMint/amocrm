...
```ruby
universe = AmoCRM::Universe.build login:'ВАШ ЛОГИН', password:'ВАШ ПАРОЛЬ'
```
...
```ruby
universe.goods.list
# => [AmoCRM::Entities::Good, AmoCRM::Entities::Good, ..]
```
...
co.applicable  = true
[...]
co.customerOrderPosition = [AmoCRM::Entities::CustomerOrderPosition.new]
...
# => [AmoCRM::Enities::Feature, AmoCRM::Enities::Feature]
```
...
# => [AmoCRM::Entities::AttributeMetadata, AmoCRM::Entities::AttributeMetadata]
```
...
# => AmoCRM::Entities::AttributeMetadata
```
...
# => [AmoCRM::Entities::Feature, ..]

attribute = good.attributes.first
# => [AmoCRM::Entities::Attribute, ..]
